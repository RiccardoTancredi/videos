...
class BrainHighlight(Scene):
    def construct(self):
        # Brain display
        brainfolder = '/Users/riccardotancredi/Documents/videos3b1b/_2024/Thesis/Data/BrainSvg'
...
class NetworkScene(InteractiveScene):
    ...
    def show_words(self):
        words = VGroup(
            Tex("Machine", "learning").set_color(GREEN),
            Tex("Neural network").set_color(BLUE),
        )
...
# class LayOutPlan(InteractiveScene, NetworkScene):
    # def setup(self):
    #     NetworkScene.setup(self)
    #     self.remove(self.network_mob)
